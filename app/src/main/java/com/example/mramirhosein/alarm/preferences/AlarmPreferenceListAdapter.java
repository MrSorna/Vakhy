...
import com.example.mramirhosein.alarm.preferences.AlarmPreference.Type;
...
//				Log.d("AlarmPreferenceListAdapter", "Finished Loading " + alarmTones.length + " Ringtones.");
				alarmsCursor.close();
		Toast.makeText(context,"INJA ", Toast.LENGTH_LONG).show();
//				
//			}
//			
//		}).run();
...
//					break;
//				case ALARM_BARCODE:
//					alarm.setBarcode((String) preference.getValue());
//					break;
//				case ALARM_TIME:
...
//		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_BARCODE, "Barcode",alarm.getBarcode(), null, alarm.getBarcode(), Type.STRING));
