...
public abstract class BaseActivity  extends Activity implements android.view.View.OnClickListener{
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_item_new1:
			if (!AlarmActivity.hasPermissions(this, AlarmActivity.PERMISSIONS)) {
				ActivityCompat.requestPermissions(this, AlarmActivity.PERMISSIONS, AlarmActivity.PERMISSION_ALL);
			}
			Intent newAlarmIntent = new Intent(this,
					AlarmPreferencesActivity.class);
			startActivity(newAlarmIntent);
			break;
		case R.id.menu_item_rate1:
...
//			}
			...
			/*
			 * Intent send = new Intent(Intent.ACTION_SENDTO); String uriText;
			 * 
			 * String emailAddress = "dontusemyemailaddress@yourdomain.com";
			 * String subject = R.string.app_name + " Bug Report"; String body =
			 * "Debug:"; body += "\n OS Version: " +
			 * System.getProperty("os.version") + "(" +
			 * android.os.Build.VERSION.INCREMENTAL + ")"; body +=
			 * "\n OS API Level: " + android.os.Build.VERSION.SDK_INT; body +=
			 * "\n Device: " + android.os.Build.DEVICE; body +=
			 * "\n Model (and Product): " + android.os.Build.MODEL + " (" +
			 * android.os.Build.PRODUCT + ")"; body += "\n Screen Width: " +
			 ...
			 * "&body=" + body;
			 * 
			 * uriText = uriText.replace(" ", "%20"); Uri emalUri =
			 * Uri.parse(uriText);
			 * 
			 * send.setData(emalUri); startActivity(Intent.createChooser(send,
			 * "Send mail..."));
			 */
			break;
		}
